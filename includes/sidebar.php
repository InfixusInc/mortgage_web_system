...
<li><a href="application-form.php"><i class="fa fa-file-o"></i>Application Form</a></li>
<li><a href="enquiries.php"><i class="fa fa-file-o"></i>Make Enquiry</a></li>
<li><a href="access-log.php"><i class="fa fa-file-o"></i>Payment History</a></li>
<?php } else { ?>
