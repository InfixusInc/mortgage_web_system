											...
											<?php	
												...
												while($row=$res->fetch_object()) { ?>
													<tr>
														...
														<td>
															<a href="update-payment.php?id=<?php echo $row->id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
															<a href="payments.php?del=<?php echo $row->id;?>" onclick="return confirm("Do you want to delete");"><i class="fa fa-close"></i></a>
														</td>
													</tr>
